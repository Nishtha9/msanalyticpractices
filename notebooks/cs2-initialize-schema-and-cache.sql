...
-- MAGIC %run
-- MAGIC 
-- MAGIC /Users/nish0349@gmail.com/cs2-volume-mounting
...
(
  ...
  "header" "true",
  "sep" ",",
  "path" "dbfs:/mnt/data/casestudy2/Customers*.csv"
);
...
(
  ...
  "header" "true",
  "sep" ",",
  "path" "dbfs:/mnt/data/casestudy2/FactSales*.csv"
);
...
(
  ...
  "header" "true",
  "sep" ",",
  "path" "dbfs:/mnt/data/casestudy2/Employees*.csv"
);
...
(
  ...
  "header" "true",
  "sep" ",",
  "path" "dbfs:/mnt/data/casestudy2/Locations*.csv"
);
...
(
  ...
  "header" "true",
  "sep" ",",
  "path" "dbfs:/mnt/data/casestudy2/ProductCategories*.csv"
);
...
(
  ...
  "header" "true",
  "sep" ",",
  "path" "dbfs:/mnt/data/casestudy2/ProductSubcategories*.csv"
);
...
(
  ...
  "header" "true",
  "sep" ",",
  "path" "dbfs:/mnt/data/casestudy2/Products*.csv"
);
...
(
  ...
  "header" "true",
  "sep" ",",
  "path" "dbfs:/mnt/data/casestudy2/SalesReasons*.csv"
);
...
(
  ...
  "header" "true",
  "sep" ",",
  "path" "dbfs:/mnt/data/casestudy2/Stores*.csv"
);
...
(
  ...
  "header" "true",
  "sep" ",",
  "path" "dbfs:/mnt/data/casestudy2/Time*.csv"
);
...
USING DELTA
LOCATION "dbfs:/mnt/data/casestudy2/orderhistory/"
